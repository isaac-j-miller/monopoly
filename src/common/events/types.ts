...
export interface RentPaymentEvent extends Event<EventType.RentPayment>, PropertyEvent, PlayerEvent {
...
export interface LoanChangeInterestRateEvent extends Event<EventType.LoanChangeInterestRate>, LoanEvent {
...
export interface DrawCommunityChestCardEvent extends Event<EventType.DrawCommunityChestCard>, PlayerEvent {
    // TODO: do something with this
}
...
export interface PlayerPayOffLoanEvent extends Event<EventType.PlayerPayOffLoan>, PlayerEvent, LoanEvent {
...
export interface UseCommunityChestCardEvent extends Event<EventType.UseCommunityChestCard>, PlayerEvent {
