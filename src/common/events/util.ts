...
import { defaultUtilityQuantityRollMultipliers, defaultRailroadQuantityRents } from "common/property/upgrades";
import { assertIsDefined, assertNever } from "common/util";
import { RentPaymentEvent } from "./types";

export const determineRentPaymentAmount = (event: Omit<RentPaymentEvent, "turn"|"order">, state: GameState): number => {
